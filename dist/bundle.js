...
var APIRequest = /** @class */ (function () {
    function APIRequest(baseUrl, urlExtension) {
        this.responsePromise = _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default()(baseUrl + urlExtension);
    }
    APIRequest.prototype.getContents = function () {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.responsePromise];
                    case 1:
                        response = _a.sent();
...
var HeroAndItemRequirements = /** @class */ (function () {
    function HeroAndItemRequirements() {
    }
    return HeroAndItemRequirements;
}());
...
var Heroes = /** @class */ (function (_super) {
    __extends(Heroes, _super);
    function Heroes(baseUrl, urlExtension) {
        var _this = _super.call(this, baseUrl, urlExtension) || this;
        _this.heroList = {};
        _this.images = 0;
        _this.hostElement = document.getElementById('app');
        _this.modifyContents();
        return _this;
    }
    Heroes.getInstance = function () {
        if (this.instance) {
            return this.instance;
        }
        this.instance = new Heroes('https://api.opendota.com/api', '/constants/heroes');
        return this.instance;
    };
    Heroes.prototype.modifyContents = function () {
        return __awaiter(this, void 0, void 0, function () {
            var data, adjObj, key;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getContents()];
                    case 1:
                        data = _a.sent();
                        adjObj = {};
                        for (key in data) {
    ...
    Heroes.prototype.clickHandler = function (event) {
        console.log(event.target.id);
    };
    Heroes.prototype.addListeners = function () {
        var _this = this;
        Array.from(this.element.childNodes).forEach(function (child) {
            child.addEventListener('click', _this.clickHandler);
        });
    };
    Heroes.prototype.renderContent = function () {
        var _this = this;
        this.templateElement = document.getElementById('tmpl-hero-overview');
        var importedNode = document.importNode(this.templateElement.content, true);
        this.element = importedNode.firstElementChild;
        this.element.id = 'hero-overview';
        for (var key in this.heroList) {
            ...
            img.onerror = function () {
                ...
                _this.images += 1;
                if (_this.images === 121) {
                    (_a = _this.hostElement.firstElementChild) === null || _a === void 0 ? void 0 : _a.remove();
...
var heroes = Heroes.getInstance();
var Items = /** @class */ (function (_super) {
    __extends(Items, _super);
    function Items(baseUrl, urlExtension) {
        var _this = _super.call(this, baseUrl, urlExtension) || this;
        _this.itemList = {};
        _this.modifyContents();
        return _this;
    ...
    Items.getInstance = function () {
        ...
        this.instance = new Items('https://api.opendota.com/api', '/constants/items');
        return this.instance;
    };
    Items.prototype.modifyContents = function () {
        return __awaiter(this, void 0, void 0, function () {
            var data, key;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Items.prototype.renderContent = function () { };
    return Items;
}(APIRequest));
