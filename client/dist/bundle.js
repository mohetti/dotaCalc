...
/***/ "./src/Components/DataExchangeHandler.ts":
/*!***********************************************!*\
  !*** ./src/Components/DataExchangeHandler.ts ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "DataExchangeHanlder": () => (/* binding */ DataExchangeHanlder)
/* harmony export */ });
/* harmony import */ var _Heroes__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Heroes */ "./src/Components/Heroes.ts");
/* harmony import */ var _Items__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Items */ "./src/Components/Items.ts");


class DataExchangeHanlder {
    constructor() {
        this.heroList = {};
        this.itemList = {};
    }
    initHeroList(apiResponse) {
        const heroes = _Heroes__WEBPACK_IMPORTED_MODULE_0__.Heroes.getInstance(apiResponse);
        this.heroList = heroes.list;
    }
    initItemList(apiResponse) {
        const items = _Items__WEBPACK_IMPORTED_MODULE_1__.Items.getInstance(apiResponse);
...
/* harmony export */ });
/* harmony import */ var _DataExchangeHandler__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./DataExchangeHandler */ "./src/Components/DataExchangeHandler.ts");
...
class StartView extends _Component__WEBPACK_IMPORTED_MODULE_2__.Component {
    constructor() {
        ...
        this.imagesLoaded = 0;
        this.selectedHeroId = '';
        this.heroList = _DataExchangeHandler__WEBPACK_IMPORTED_MODULE_0__.DataExchangeHanlder.getInstance().heroList;
        this.render();
    }
    render() {
...
/* harmony import */ var _Components_DataExchangeHandler__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Components/DataExchangeHandler */ "./src/Components/DataExchangeHandler.ts");



_Components_Router__WEBPACK_IMPORTED_MODULE_0__.Router.loading();
const dataExchangeHandler = _Components_DataExchangeHandler__WEBPACK_IMPORTED_MODULE_2__.DataExchangeHanlder.getInstance();
let heroes;
let items;
