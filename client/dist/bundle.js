...
class GameView extends _Component__WEBPACK_IMPORTED_MODULE_0__.Component {
    ...
    callNextOpponent(event) {
        if (_index__WEBPACK_IMPORTED_MODULE_1__.dataContainer.gameState.currentOpponent.localized_name === 'Sven') {
            return;
        }
