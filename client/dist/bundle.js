...
/* harmony export */ });
/* harmony import */ var _Util__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Util */ "./src/Components/Util.ts");
...
class Heroes {
    constructor() {
        ...
        this.templateElement = document.getElementById('tmpl-hero-overview');
        this.imagesLoaded = 0;
    ...
    retrieveHeroes() {
        return __awaiter(this, void 0, void 0, function* () {
            const data = yield _Util__WEBPACK_IMPORTED_MODULE_0__.Util.getData('https://api.opendota.com/api', '/constants/heroes');
            this.heroes = data;
    ...
    dropHandler(event) {
        ...
        if ((_a = this.element[1].firstElementChild) === null || _a === void 0 ? void 0 : _a.firstElementChild) {
            (_b = this.element[1].firstElementChild) === null || _b === void 0 ? void 0 : _b.firstElementChild.remove();
        }
...
], Heroes.prototype, "dragStartHandler", null);
__decorate([
    _Decorators_autobind__WEBPACK_IMPORTED_MODULE_1__.autobind
], Heroes.prototype, "dragEndHandler", null);
__decorate([
    _Decorators_autobind__WEBPACK_IMPORTED_MODULE_1__.autobind
], Heroes.prototype, "dragOverHandler", null);
__decorate([
    _Decorators_autobind__WEBPACK_IMPORTED_MODULE_1__.autobind
], Heroes.prototype, "dragLeaveHandler", null);
__decorate([
    _Decorators_autobind__WEBPACK_IMPORTED_MODULE_1__.autobind
], Heroes.prototype, "dropHandler", null);
...
class Loading {
    constructor() {
        this.hostElement = document.getElementById('app');
        this.templateElement = document.getElementById('tmpl-loading-screen');
        const importedNode = document.importNode(this.templateElement.content, true);
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Components_Loading__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Components/Loading */ "./src/Components/Loading.ts");
/* harmony import */ var _Components_Heroes__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Components/Heroes */ "./src/Components/Heroes.ts");


const loading = _Components_Loading__WEBPACK_IMPORTED_MODULE_0__.Loading.getInstance();
const heroes = _Components_Heroes__WEBPACK_IMPORTED_MODULE_1__.Heroes.getInstance();
heroes
    .retrieveHeroes()
    .then(() => {
    heroes.render();
